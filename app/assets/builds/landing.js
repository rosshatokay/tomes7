...
// app/javascript/utils/hideSplitElms.js
var hideSplitElms = (elm, display) => {
...
var hideSplitElms_default = hideSplitElms;
...
function animateLandingPage() {
  ...
  titleSplit.lines.forEach((line) => hideSplitElms_default(line, "inline-block"));
  subtitleSplit.lines.forEach((line) => hideSplitElms_default(line, "inline-block"));
  tl.from(titleSplit.lines, {
    ...
    duration: 2,
    ease: "expo.inOut"
  }, "-=1.5").from(".splash-g-1", imageOpts, "-=0.9").from(".splash-g-2", imageOpts, "-=1.4").from(".splash-g-3", imageOpts, "-=1.3").from(".splash-g-4", imageOpts, "-=1.4").play();
}
...
gsap/CSSPlugin.js:
  ...
  *)
*/
//# sourceMappingURL=/assets/landing.js.map
